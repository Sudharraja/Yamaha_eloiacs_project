...
<form action="" method="post" >
    ...
    <div class="row">
        <div class="col-4">
          <div class="form-group">
            <label>Material Code:</label> </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
            <label>Models:</label>
              </DIV></DIV>  </DIV>
        ...
        <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="materialcode" value="<?php echo $row["Material Code"]; ?>" readonly>
  </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="models" value="<?php echo $row["Models"]; ?>" required >
              </DIV></DIV> </DIV>
        ...
        <div class="col-4">
          <div class="form-group">
            <label>Active / Inactive:</label> </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
  ...
  <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="ex" value="<?php echo $row["Ex showroom"]; ?>" required>
              </DIV></DIV> </DIV>
  ...
  <div class="col-4">
        ...
        <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="rt" value="<?php echo $row["LT/RT"]; ?>" required>
  </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="insurance" id="insurance" value="<?php echo $row["Insurance"]; ?>" required>
           </DIV></DIV> </DIV>
...
<div class="row">
        <div class="col-4">
          <div class="form-group">
            <label>Accessories:</label> </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
        ...
        <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="accessories" value="<?php echo $row["Accessories"]; ?>"  required>
  </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="plus" value="<?php echo $row["Pro Plus"]; ?>" required>
              </DIV></DIV> </DIV>
        ...
        <div class="col-4">
          <div class="form-group">
            <label>On Road Price:</label> 
              ...
              <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="text" name="orp" value="<?php echo $row["On Road Price"]; ?>" required>
              </DIV></DIV> </DIV>
