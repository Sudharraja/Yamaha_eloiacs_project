...
<div class="row">
  ...
  <div class="col-4">
        ...
        <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="date" name="file_received_date" value="<?php echo $row["FILERECEIVEDDATE"]; ?>" max="<?= date('Y-m-d') ?>"  required>
  </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
  ...
  <div class="col-4">
        ...
        <div class="col-4">
          <div class="form-group">
          <input class="form-control" type="date" name="registration_date" value="<?php echo $row["REGISTRATIONDATE"]; ?>"  max="<?= date('Y-m-d') ?>" required>
  </DIV></DIV>
  <div class="col-4">
          <div class="form-group">
