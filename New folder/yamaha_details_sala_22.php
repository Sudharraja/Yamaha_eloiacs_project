                            ...
                            <div class="col-md-12">
                                ...
                                <?php 
                                    ...
                                    if(isset($_GET['stud_id']))
                                    {
                                        ...
                                        $employee_query = "SELECT * FROM yamaha_employee_data WHERE id='$stud_id' ";
  ...
  function calculateTotalWorkingDays() {
    ...
    if (!isNaN(company_basic_pay)) {
      ...
      if (company_basic_pay <= 10000) {
        epf_basic = final_BasicSalary * 30 / 100;
      } else {
        epf_basic = (3334 / monthlyWorkingDays) * employee_WorkingDays;
      }
...
if (esiEpfOption === 'Yes') {
  totalsalary_all_value = (convenience_final + ot + final_BasicSalary) - (advance + epf_employee + esi_employee);
} else {
  totalsalary_all_value = (convenience_final + ot + final_BasicSalary) - (advance);
}
